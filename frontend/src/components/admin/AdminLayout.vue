...
const updateShowNotifications = (value) => {
  showNotifications.value = value;
};
const updateShowUserMenu = (value) => {
  showUserMenu.value = value;
};
const updateShowQuickAdd = (value) => {
  showQuickAdd.value = value;
};
const markAllAsRead = () => {
...
const sidebarItems = ref([
  ...
  { id: "stocks", name: "Stocks", icon: "ArchiveIcon", path: "/admin/stocks" },
  {
    id: "orders",
    name: "Orders",
