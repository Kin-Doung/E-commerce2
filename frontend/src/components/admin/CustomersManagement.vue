          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr 
                ...
                :class="{ 'bg-emerald-50': selectedCustomers.includes(customer.id) }"
              >
                <!-- Checkbox -->
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <div class="relative inline-block text-left">
                    <button
                      ...
                      :class="{ 'bg-gray-50 ring-2 ring-emerald-500': activeMenuId === customer.id }"
                    >
...
const isAllSelected = computed(() => {
  return paginatedCustomers.value.length > 0 && 
         paginatedCustomers.value.every(customer => selectedCustomers.value.includes(customer.id))
})
...
const toggleSelectAll = () => {
  if (isAllSelected.value) {
    selectedCustomers.value = selectedCustomers.value.filter(id => 
      !paginatedCustomers.value.some(customer => customer.id === id)
    )
  } else {
