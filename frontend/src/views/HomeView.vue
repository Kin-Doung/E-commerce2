<template>
  <div>
    <!-- Hero Section -->
    <section
      class="relative bg-gradient-to-br from-blue-50 to-white py-20 lg:py-32"
    >
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p class="text-xl text-gray-600 mb-8">
              Discover our premium collection of water solutions designed for
              clean, healthy hydration. From advanced filtration systems to
            ...
            <div class="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              <router-link to="/about">
                <button
                  class="px-6 py-3 border border-gray-300 text-gray-700 hover:bg-gray-50 font-medium rounded-md transition-colors"
                >
                  Learn More
                </button>
              </router-link>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            We're committed to providing the highest quality water solutions
            with exceptional service and environmental responsibility.
          </p>
        </div>
    ...
    <section class="py-20 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover our most popular water solutions, carefully selected for
        ...
        <div class="text-center">
          <router-link to="/shop">
            <button
              class="px-6 py-3 border border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-medium rounded-md transition-colors"
            >
              View All Products
            </button>
          </router-link>
    ...
    <section class="bg-blue-600 py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl font-bold text-white mb-4">
          Stay Hydrated with Our Newsletter
        </h2>
...
const features = ref([
  {
    ...
    description:
      "State-of-the-art filtration technology removes 99.9% of contaminants while preserving essential minerals.",
  },
  {
    icon: RecycleIcon,
    title: "Eco-Friendly",
    description:
      "Sustainable packaging and products designed to reduce environmental impact and promote green living.",
  },
  {
    icon: AwardIcon,
    title: "Certified Quality",
    description:
      "All products meet international quality standards and are certified by leading health organizations.",
  },
  {
    icon: TruckIcon,
    title: "Free Delivery",
    description:
      "Fast, reliable delivery service with free shipping on orders over $50 to your doorstep.",
  },
]);
